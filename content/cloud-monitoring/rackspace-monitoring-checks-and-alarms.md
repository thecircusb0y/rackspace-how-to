...
The common checks are displayed along with the cloud servers in the [Cloud Control panel](http://mycloud.rackspace.com/).  For more information, see [Ceating a monitoring check using the cloud control panel](https://support.rackspace.com/how-to/creating-a-monitoring-check-using-the-cloud-control-panel/)
